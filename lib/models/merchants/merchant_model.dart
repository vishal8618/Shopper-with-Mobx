...
List<MerchantModel> merchantsFromJson(String str) =>
    List<MerchantModel>.from(
        json.decode(str).map((x) => MerchantModel.fromJson(x)));

String merchantsToJson(List<MerchantModel> data) =>
...
class MerchantModel {
  ...
  factory MerchantModel.fromJson(Map<String, dynamic> json) =>
      MerchantModel(
          id: json["id"],
          email: json["email"],
          followers: json["followers"] == null ? List() : List<int>.from(
              json["followers"].map((x) => x)),
          userId: json["user_id"],
          logo: json["logo"],
          avatar: json["avatar"],
          openAndClose: json["open_and_close"],
          merchantPhoto: json["merchant_photo"],
          phoneActivated: json["is_phone_number_visible"] == null
              ? false
              : json["is_phone_number_visible"],
          ...
          url: json["url"],
          followersCount: json.containsKey("followers_count") ? json["followers_count"] : ""
      );
  ...
  "url": url,
  "followers": followers == null ? null : List<dynamic>.from(followers.map((x) =>
      x)),
